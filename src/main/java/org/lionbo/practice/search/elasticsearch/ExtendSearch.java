 ...
 * @author liuyongbo
 */
public class ExtendSearch extends AbstractAction<SearchResultWithSocre> {

    private String query;
    private List<Sort> sortList = new LinkedList<Sort>();

    private ExtendSearch(Builder builder) {
        super(builder);
    ...
    public SearchResultWithSocre createNewElasticSearchResult(String responseBody, int statusCode, String reasonPhrase,
            Gson gson) {
        return createNewElasticSearchResult(new SearchResultWithSocre(gson), responseBody, statusCode, reasonPhrase,
                gson);
    }
    ...
    public boolean equals(Object obj) {
        ...
        ExtendSearch rhs = (ExtendSearch) obj;
        return new EqualsBuilder().appendSuper(super.equals(obj)).append(query, rhs.query)
                .append(sortList, rhs.sortList).isEquals();
    }

    public static class Builder extends AbstractMultiTypeActionBuilder<ExtendSearch, Builder> {
        private String query;
        private List<Sort> sortList = new LinkedList<Sort>();
        ...
        @Override
        public ExtendSearch build() {
            return new ExtendSearch(this);
        }
    }
}
